    ...
    public boolean run (Player player, String[] args)
      throws CommandException {
        ...
        if (subc.equalsIgnoreCase("add"))
        {
            ...
            // position
            users.setProperty(MinorUtils.UserNodeChomp(player, arg, "coord.X"), player.getLocation().getX());
            users.setProperty(MinorUtils.UserNodeChomp(player, arg, "coord.Y"), player.getLocation().getY());
            users.setProperty(MinorUtils.UserNodeChomp(player, arg, "coord.Z"), player.getLocation().getZ());
            // eye direction
            ...
            users.setProperty(MinorUtils.UserNodeChomp(player, arg, "world"), player.getLocation().getWorld().getName().toString());
            users.save();
        ...
        else if (subc.equalsIgnoreCase("test"))
        {
            ...
            users.setProperty(MinorUtils.UserNodeChomp(player, "testnode", "coord.X"), x);
            users.setProperty(MinorUtils.UserNodeChomp(player, "testnode", "coord.Y"), y);
            users.setProperty(MinorUtils.UserNodeChomp(player, "testnode", "coord.Z"), z);
            users.save();
            ConfigurationNode n = users.getNode(MinorUtils.UserNodeChomp(player, "testnode", "coord"));
            MinorUtils.TransferNode(users, MinorUtils.UserNodeChomp(player, "testnode", "coord"), n);
            users.save();
            users.removeProperty(MinorUtils.BaseNodeChomp(player, "testnode"));
            users.save();
